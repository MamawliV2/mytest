...
read -p "Enter your phone number (with country code, e.g., +989123456789): " phone_number

# Validate the phone number (only digits and length between 10 to 15 digits after the country code)
